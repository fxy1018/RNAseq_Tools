...
def sam2bam(samFile):
    ...
    sam2bam = "sudo sh -c \"/home/xfan/anaconda3/envs/quantifer/bin/samtools view -S -b " + tempFile.path + " > " + bamFile.path + "\"" 
...
def sortbam(bamFile):
    ...
    sortbam = "sudo /home/xfan/anaconda3/envs/quantifer/bin/samtools sort " + bamFile.path + " -o " + sortbamFile.path
    try:
        os.system(sortbam)
    except:
